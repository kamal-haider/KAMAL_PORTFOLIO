...
const socialLinks = [
  ...
  },
  {
    ...
    href: 'https://linkedin.com/in/kamal-haider',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="border border-border bg-void/80 backdrop-blur-sm overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pl-6 text-text-primary font-mono text-sm">
                  Kamal Haider — Fullstack AI Engineer
                </div>
          ...
          <div>
            ...
            >
              ...
              <p className="text-text-secondary mb-6">
                Open to senior fullstack roles, AI architecture consulting,
                or building your next AI-powered product end-to-end.
              </p>
              <a
                href="mailto:mr.haiderk@gmail.com"
                onMouseEnter={handleHover}
